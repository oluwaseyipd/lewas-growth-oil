  ...
  return (
    <div className="relative overflow-hidden w-full py-2">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, rgba(255,255,255,0.92) 70%, rgba(255,255,255,0.0) 100%)",
        }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to left, rgba(255,255,255,0.92) 70%, rgba(255,255,255,0.0) 100%)",
        }}
        aria-hidden="true"
      />
      <div
...
export default function TestimonialsPreview() {
  return (
    <section
      className="w-full py-20 bg-[color:var(--color-neutral-white)]"
